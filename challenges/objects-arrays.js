...
// uni = graduates.filter(item => item.university === 'Uni') Attempt 1

// for (i = 0; i < graduates.length; i++) { Attempt 2
//   graduates[i].university;
//   if (graduates === 'Uni')
...
//Had to change from const to let?
...
*/
let lowerPopulation = zooAnimals.filter(zooAnimal => {
